...
, api = yp.config
  ...
  api.init = function() {
    ...
    api.loader = {
      require: {
        paths: {
          'tree.plus': 'tree.plus.jquery'
        }
        , shim: {
          'tree.plus': ['tree.jquery']
        , 'common': ['modernizr', 'bootstrap.min', 'jquery.slimscroll.min']
        }
      }
    ...
    , js: api.loader.baseUrl + 'dashboard/j'
    , css: api.loader.baseUrl + 'dashboard/css/'
    , html: api.loader.baseUrl + 'test/'
    };
    api.loader.require.baseUrl = api.loader.baseUrl.js;
    /*api.loader.baseList = $.map(['form'], function(val) {
      return api.loader.require.baseUrl + val;
    });*/
    $.sub('system-dataNeedChrome.config', function() {
      api.loader.baseList.unshift('chrome');
    });
    if (win.ibox_init === undefined) {
      api.loader.baseList.push('ibox');
    }/**/
  }
